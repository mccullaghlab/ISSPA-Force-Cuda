...
tf = np.loadtxt("/home/ryan/Desktop/isspa/isspa2_v3_forces/timing_tests/LJ3_23/p0.5_m0.5_n0.0/parallel/LJ3.forces.combined.dat",usecols=(1,7))
...
for j,val in enumerate(values):
    ...
    tf = np.loadtxt("/home/ryan/Desktop/isspa/isspa2_v3_forces/timing_tests/LJ2/p0.5_m0.5/25/LJ2.forces.combined.dat")
    nBins = len(tf)
    ...
    plt.xlim((0,cutoff))
    plt.ylim((-3.0,2.0))
    plt.savefig('p0.5_m0.5_n0.0.%s.zz.forces.pdf' %(val))
    plt.savefig('p0.5_m0.5_n0.0.%s.zz.forces.png' %(val))
    plt.close()
