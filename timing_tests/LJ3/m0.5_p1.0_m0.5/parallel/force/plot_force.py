...
tf = np.loadtxt("/home/ryan/Desktop/isspa/isspa2_v3_forces/timing_tests/LJ3_23/m0.5_p1.0_m0.5/parallel/LJ3.forces.combined.dat",usecols=(1,7))
...
for j,val in enumerate(values):
    ...
    tf = np.loadtxt("/home/ryan/Desktop/isspa/isspa2_v3_forces/timing_tests/LJ2/p1.0_m0.5/25/LJ2.forces.combined.dat")
    nBins = len(tf)
    ...
    plt.xlim((0,cutoff))
    plt.ylim((-5.0,2.0))
    plt.savefig('m0.5_p1.0_m0.5.%s.zz.forces.pdf' %(val))
    plt.savefig('m0.5_p1.0_m0.5.%s.zz.forces.png' %(val))
    plt.close()
