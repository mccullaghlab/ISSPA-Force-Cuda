...
tf = np.loadtxt("/home/ryan/Desktop/isspa/isspa2_v3_forces/timing_tests/LJ3_23/p1.0_m1.0_n0.0/parallel/LJ3.forces.combined.dat",usecols=(1,4))
...
for j,val in enumerate(values):
    ...
    plt.xlim((0,cutoff))
    plt.ylim((-7.0,2.0))
    plt.savefig('p1.0_m1.0_n0.0.%s.zz.forces.pdf' %(val))
    plt.savefig('p1.0_m1.0_n0.0.%s.zz.forces.png' %(val))
    plt.close()
