...
pLJdat=np.loadtxt("s7.00/LJ.qp{:4.2f}.dn0.21.gr1".format(qp))
mLJdat=np.loadtxt("s7.00/LJ.qm{:4.2f}.dn0.21.gr1".format(qm))
pCdat=np.loadtxt("s7.00/LJ.qp{:4.2f}.dn0.21.gr1".format(qp))
mCdat=np.loadtxt("s7.00/LJ.qm{:4.2f}.dn0.21.gr1".format(qm))
