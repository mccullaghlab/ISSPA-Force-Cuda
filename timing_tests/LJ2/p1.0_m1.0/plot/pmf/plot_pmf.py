...
def plot_4d(xdata1, ydata1, label1, xdata2, ydata2, label2, xdata3, ydata3, label3, xdata4, ydata4, label4, x_axis, y_axis, system):
        ...
        plt.plot(xdata2, ydata2, 'r',label = label2,linestyle='--')
        plt.plot(xdata3, ydata3, 'b',label = label3,linestyle='--')
        plt.plot(xdata4, ydata4, 'g',label = label4,linestyle='--')
...
data25 = np.loadtxt("/home/ryan/Desktop/isspa/isspa2_v3_forces/timing_tests/LJ2/p1.0_m1.0/25/pmf.dat")
